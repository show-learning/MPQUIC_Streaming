...
type outgoingBidiStreamsMap = outgoingStreamsMap[streamI]
type outgoingUniStreamsMap = outgoingStreamsMap[sendStreamI]

func newOutgoingBidiStreamsMap(
	newStream func(protocol.StreamNum) streamI,
	queueControlFrame func(wire.Frame),
) *outgoingBidiStreamsMap {
	return &outgoingStreamsMap[streamI]{
...
func newOutgoingUniStreamsMap(
	...
	return &outgoingStreamsMap[sendStreamI]{
...
type outgoingStreamsMap[T interface{
